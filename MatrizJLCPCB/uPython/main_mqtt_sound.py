...
print("uPython Matrix JLCPCB con audio")
...
try:
    ...
    varconfig={"equipo":EQUIPO,"tiempontp":3600,"huso":-18000,"chatid":"727498654",
               "botid":"1737167982:AAEfbJSqPZ9RB084GFqNEo_xBPcZRVERbLk","enamsg":True,"brillo":10,"cntrini":0,"filesound":1}
...
filesound=varconfig.get("filesound")
print("filesound=",filesound)
    ...
    while brokerok:
        try:
            ...
            if newmqttcmd:
              ...
              if mqtttopic == topiclist[7]:  #inisound
                print('ESPcmdsound>',mqttcmd)
                comando=mqttcmd.decode('utf-8')
                print("Cmd>",comando)
                try:
                    if comando=="0":
